export default function SwitchFollow() {
    return (
        <>
          <div className="flex items-center">
            ...
            />
            <h5 className="text-white pl-5 flex justify-between">
              Guswan_di
              <span className="text-blue-600 font-bold text-sm ml-12">
                switch
              </span>
            </h5>
          </div>
          <div>
            ...
            <div className="flex items-center">
              ...
              <h5 className="text-white pl-5 flex justify-between">
                Guswan_di
                <span className="text-blue-600 text-sm ml-12">follow</span>
              </h5>
            </div>
